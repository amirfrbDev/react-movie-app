...
const getPopularTvsByPage = ({ queryKey }) => api.get(
    `discover/tv?page=${queryKey[1]}&sort_by=${queryKey[2]}&show_me=${queryKey[3].show_me}&air_date.gte=${queryKey[3]["air_date.gte"]}&air_date.lte=${queryKey[3]["air_date.lte"]}&with_genres=${queryKey[3].with_genres?.join(",")}&with_original_language=${queryKey[3].with_original_language || ""}`
);
